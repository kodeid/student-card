...
export default function StudentAnalytics({filteredData, arrPhase, activePhase}) {
  return (
    <>
      {filteredData &&
                ...
                return (
                  <div key={scoreIdx}>
                    ...
                    {Object.keys(score).map((component, idx) => {
                      return <StudentSectionChart key={idx} idx={idx} phase={phase} component={component} scoreIdx={scoreIdx} score={score} />
                    })}
                  </div>
                )
              })}
